...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${base}/ydelser/ai-systems-audit`,         priority: 0.85, changeFrequency: "monthly" as const },
    { url: `${base}/ydelser/ai-governance-program`,       priority: 0.85, changeFrequency: "monthly" as const },
    { url: `${base}/ydelser/ai-governance-accelerator`,   priority: 0.85, changeFrequency: "monthly" as const },
    { url: `${base}/ydelser/ai-implementation-partner`,   priority: 0.85, changeFrequency: "monthly" as const },
    ...
    { url: `${base}/eu-ai-act`, priority: 0.9,  changeFrequency: "monthly" as const },
