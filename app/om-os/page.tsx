        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5 mt-8">
            {[
              ...
              { label: "AI Governance", accent: "#cc2222", text: "Definer governance rammen, EU AI Act klassificering og risikomodel. Kravspecifikationen der driver implementeringen." },
              { label: "Implementeringsledelse", accent: "#2d1a1a", text: "Driv governance programmet i mål og opdater EA kortlægningen med nye realiteter. Cyklussen gentager sig." },
            ].map((d) => (
